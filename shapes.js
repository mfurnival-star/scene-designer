...
// COPILOT_PART_konva: 2025-09-12T13:33:00Z
/*********************************************************
 * [konva] Canvas Panel – Image Display & Shape Creation
 * ------------------------------------------------------
 * Handles Canvas setup, image loading, and single-shape creation/selection.
...
(function () {
  ...
  function selectShape(shape) {
    ...
    // --- FIX: Always update highlights and clear group bounding box on selection ---
    if (AppState._multiSelect && typeof AppState._multiSelect.updateSelectionHighlights === "function") {
      AppState._multiSelect.updateSelectionHighlights();
    }
    if (AppState._multiSelect && typeof AppState._multiSelect.clearGroupBoundingBox === "function") {
      AppState._multiSelect.clearGroupBoundingBox();
    }
  ...
  function deselectShape() {
    ...
    // --- FIX: Always update highlights and clear group bounding box on deselect ---
    if (AppState._multiSelect && typeof AppState._multiSelect.updateSelectionHighlights === "function") {
      AppState._multiSelect.updateSelectionHighlights();
    }
    if (AppState._multiSelect && typeof AppState._multiSelect.clearGroupBoundingBox === "function") {
  ...
  window.buildCanvasPanel = async function (rootDiv, container, state) {
    ...
    function addPointShape() {
      ...
      // Always update highlights on shape add
      if (AppState._multiSelect && typeof AppState._multiSelect.updateSelectionHighlights === "function") {
        AppState._multiSelect.updateSelectionHighlights();
      }
      if (AppState._multiSelect && typeof AppState._multiSelect.clearGroupBoundingBox === "function") {
