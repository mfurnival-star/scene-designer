...
/**
 * Golden Layout Panel Factory: Build and mount the canvas panel into rootElement.
 * @param {HTMLElement} rootElement
 * @param {GoldenLayout.Container} container
 */
export function buildCanvasPanel(rootElement, container) {
  log("INFO", "[canvas] Mounting Canvas panel");
  // The rootElement is a fresh empty div. Use it as Konva container.
  initCanvas(rootElement);
}
